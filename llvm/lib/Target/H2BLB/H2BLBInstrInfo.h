...
public:
  H2BLBInstrInfo(const H2BLBSubtarget &STI);
  const H2BLBRegisterInfo &getRegisterInfo() const { return RegisterInfo; }
  ...
  void loadRegFromStackSlot(
      ...
      Register DestReg, int FI, const TargetRegisterClass *RC, Register VReg,
      unsigned SubReg = 0,
      MachineInstr::MIFlag Flags = MachineInstr::NoFlags) const override;
