...
struct CGBR : public MachineFunctionPass {
  ...
  bool runOnMachineFunction(MachineFunction &MF) override {
    ...
    BuildMI(FirstMBB, MBBI, DL, TII->get(OR1K::MOVHI), Scratch1)
        .addExternalSymbol("_GLOBAL_OFFSET_TABLE_", OR1KII::MO_GOTPCHI);
    BuildMI(FirstMBB, MBBI, DL, TII->get(OR1K::ORI), Scratch2)
        .addReg(Scratch1)
        .addExternalSymbol("_GLOBAL_OFFSET_TABLE_", OR1KII::MO_GOTPCLO);
...
char CGBR::ID = 0;
FunctionPass *llvm::createOR1KGlobalBaseRegPass() { return new CGBR(); }
