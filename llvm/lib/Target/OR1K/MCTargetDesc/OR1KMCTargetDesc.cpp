...
static MCAsmInfo *createOR1KMCAsmInfo(const MCRegisterInfo &MRI,
  ...
  MCCFIInstruction Inst =
      MCCFIInstruction::cfiDefCfa(0, MRI.getDwarfRegNum(OR1K::R1, true), 0);
...
static MCStreamer *
createMCStreamer(const Triple &T, MCContext &Context,
...
extern "C" void LLVMInitializeOR1KTargetMC() {
  ...
  TargetRegistry::RegisterELFStreamer(TheOR1KTarget, createMCStreamer);
