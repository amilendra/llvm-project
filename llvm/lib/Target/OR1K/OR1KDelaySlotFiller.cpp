...
static cl::opt<bool>
    DisableDelaySlotFiller("disable-or1k-delay-filler", cl::init(false),
                           cl::desc("Do not fill OR1K delay slots"),
                           cl::Hidden);

static cl::opt<bool>
    CompatDelaySlotFiller("compat-or1k-delay-filler", cl::init(false),
...
public:
  ...
  StringRef getPassName() const override { return "OR1K Delay Slot Filler"; }
...
private:
  ...
  bool IsRegInSet(const TargetRegisterInfo *TRI, SmallSet<unsigned, 32> &RegSet,
                  unsigned Reg);
...
///
FunctionPass *llvm::createOR1KDelaySlotFillerPass() { return new Filler(); }
