...
; CHECK: st  $[[T3]], 0($[[T1]])
  ...
  call void asm "st $1, $0", "=*m,r"(i32* elementtype(i32) %l1, i32 %x) nounwind
  %0 = call i32 asm "ld $0, $1", "=r,*m"(i32* elementtype(i32) %l1) nounwind
...
define void @main() {
entry:
  tail call void asm sideeffect "    ld    $0,${1};", "r,*m,~{$11}"(i32 undef, i32* elementtype(i32) getelementptr inbounds ([20 x i32], [20 x i32]* @b, i32 0, i32 3))
  ret void
}
