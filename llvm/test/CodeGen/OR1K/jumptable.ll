...
sw.bb4:                                           ; preds = %entry
  store i32 4, ptr %retval
  br label %return

sw.bb5:                                           ; preds = %entry
  store i32 5, ptr %retval
  br label %return

sw.bb6:                                           ; preds = %entry
  store i32 6, ptr %retval
  br label %return

sw.bb7:                                           ; preds = %entry
  store i32 7, ptr %retval
  br label %return
...
sw.bb9:                                           ; preds = %entry
  store i32 9, ptr %retval
  br label %return

sw.bb10:                                          ; preds = %entry
  store i32 10, ptr %retval
  br label %return

sw.bb11:                                          ; preds = %entry
  store i32 11, ptr %retval
  br label %return

sw.default:                                       ; preds = %entry
  store i32 12, ptr %retval
  br label %return
