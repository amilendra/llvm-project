# RUN: llvm-mc %s -filetype=obj -triple=riscv032 | llvm-readobj -h - \
# RUN:     | FileCheck -check-prefix=RV32 %s
# RUN: llvm-mc %s -filetype=obj -triple=riscv064 | llvm-readobj -h - \
# RUN:     | FileCheck -check-prefix=RV64 %s

# RV32: Format: ELF32-RISCV0
# RV32: Arch: riscv032
...
# RV32:   Machine: EM_RISCV0 (0x3E7)
# RV32:   Version: 1
# RV32:   Flags [ (0x0)
# RV32:   ]
# RV32: }

# RV64: Format: ELF64-RISCV0
# RV64: Arch: riscv064
